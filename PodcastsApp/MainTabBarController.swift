...
//            self.tabBar.transform = CGAffineTransform(translationX: 0, y: 100 )
    ...
    fileprivate func setupViewControllers() {
        ...
        viewControllers = [generateNavController(with: PodcastsSearchController(), title: "Search", imageName: "search"),
            generateNavController(with: favoritesController, title: "Favorites", imageName: "favorites"),  generateNavController(with: DownloadsController(), title: "Downloads", imageName: "downloads")
        ]
    }
